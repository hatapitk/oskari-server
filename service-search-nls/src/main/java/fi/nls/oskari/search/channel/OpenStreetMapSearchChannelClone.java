...
/**
 * Clone from oskari-control-example module's fi.nls.oskari.search.OpenStreetMapSearchChannel
 */
@Oskari(OpenStreetMapSearchChannelClone.ID)
public class OpenStreetMapSearchChannelClone extends SearchChannel {

    /** logger */
    private Logger log = LogFactory.getLogger(this.getClass());
    private String serviceURL = null;
    public static final String ID = "OPENSTREETMAP_CHANNEL_CLONE";
    public final static String SERVICE_SRS = "EPSG:4326";

    private static final String PROPERTY_SERVICE_URL = "search.channel.OPENSTREETMAP_CHANNEL_CLONE.service.url";
    ...
    public void init() {
        ...
        forceCoordinateSwitch = PropertyUtil.getOptional("search.channel.OPENSTREETMAP_CHANNEL_CLONE.forceXY", forceCoordinateSwitch);
